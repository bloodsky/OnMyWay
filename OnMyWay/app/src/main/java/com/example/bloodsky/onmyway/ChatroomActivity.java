...
import com.example.bloodsky.onmyway.adapters.ChatMessageRecyclerAdapter;
import com.example.bloodsky.onmyway.models.ChatMessage;
        ...
        View.OnClickListener
{
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful()) {
                    if(task.getResult().toObject(UserLocation.class) != null) {
                        userLocationArrayList.add(task.getResult().toObject(UserLocation.class));
                    }
                }
            }
        });
    ...
    private void inflateUserListFragment(){
        ...
        bundle.putParcelableArrayList(getString(R.string.intent_user_locations),userLocationArrayList);
    ...
    private void setChatroomName(){
        toolbar.setTitle(mChatroom.getTitle());
    }
